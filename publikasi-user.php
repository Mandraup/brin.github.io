                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink_1">
                                ...
                                <a class="dropdown-item" href="form-user.php">Register Akun Pengguna</a>
        ...
        <div class="container paddding">
            <div class="row mx-0">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita2-user.php" class="fh5co_magna py-2">Layanan Arsip Kawasan Yogyakarta Studi
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita3-user.php" class="fh5co_magna py-2"> Kunjungan Tim Layanan Arsip Karang Sambung
                            Kebumen.
                        </a> <a href="berita3-user.php" class="fh5co_mini_time py-3"> Layanan Sistem Informasi Kearsipan Yogyakarta
                            -
                            April 18,2016 </a>
                        <div class="fh5co_consectetur"> Tim Layanan Arsip Kawasan Yogyakarta Biro Komunikasi Publik,
                            Umum dan Kesekretariatan Badan
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita5-user.php" class="fh5co_magna py-2">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus
                                Mengikuti Uji Kompetensi Tahun 2023. </a> <a href="berita5-user.php"
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita6-user.php" class="fh5co_magna py-2"> SDM dari Layanan Arsip
                                Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun
                                2023 </a> <a href="berita5-user.php"
                            class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan Yogyakarta -
                            April 18,2016 </a>
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita3-user.php" class="d-block fh5co_small_post_heading"><span class="">Kunjungan Tim Layanan Kearsipan
                                Karangsambung
                                Kebumen </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-user.php" class="d-block fh5co_small_post_heading"><span class="">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita6-user.php" class="d-block fh5co_small_post_heading"><span class=""> SDM dari Layanan Arsip
                                Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun
                                2023 </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
