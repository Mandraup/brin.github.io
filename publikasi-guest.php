                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink_1">
                                ...
                                <a class="dropdown-item" href="form-guest.php">Register Akun Pengguna</a>
        ...
        <div class="container paddding">
            <div class="row mx-0">
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                    <div>
                        <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Publikasi</div>
                    </div>
                </div>
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="images/karyatulisilmiah1.jpeg" alt="" /></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="https://digitalcommons.unl.edu/libphilprac/7855/" class="fh5co_magna py-2">Optimizing
                            the Management of the Records Center in the Archive Rescue Program in the Eka Karya Bali
                            Juli 11, 2023 </a> <a href="#" class="fh5co_mini_time py-3"></a>
                        <div class="fh5co_consectetur"> The Eka Karya Botanical Garden Scientific Conservation Area
                            is one of the Archival Units II which is included in the Archive Area Service of the
                            National Research and Innovation Agency with the duties and responsibilities of managing
                            inactive archives that have a retention of under 10 years.
                        </div>
                    </div>
                </div>
                <div class="row pb-4">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita3-guest.php" class="fh5co_magna py-2"> Kunjungan Tim Layanan Arsip Karang Sambung
                            Kebumen.
                        </a> <a href="berita3-guest.php" class="fh5co_mini_time py-3"> Layanan Sistem Informasi Kearsipan Yogyakarta
                            -
                            April 18,2016 </a>
                        <div class="fh5co_consectetur"> Tim Layanan Arsip Kawasan Yogyakarta Biro Komunikasi Publik,
                            Umum dan Kesekretariatan Badan
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="images/sertifikasi_jabatan.jpeg" alt="" />
                            </div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <a href="berita5-guest.php" class="fh5co_magna py-2">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus
                                Mengikuti Uji Kompetensi Tahun 2023. </a> <a href="berita5-guest.php"
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="images/Picture1.jpg" alt="" />
                            </div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <a href="berita6-guest.php" class="fh5co_magna py-2"> SDM dari Layanan Arsip
                                ...
                                2023 </a> <a href="berita5-guest.php"
                            class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan Yogyakarta -
                            April 18,2016 </a>
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/kunjunganugm.png" alt="" /></div>
                        <div>
                            <a href="#" class="d-block fh5co_small_post_heading"><span class="">Layanan Arsip Kawasan
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita3-guest.php" class="d-block fh5co_small_post_heading"><span class="">Kunjungan Tim Layanan Kearsipan
                                Karangsambung
                                Kebumen </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="#" class="d-block fh5co_small_post_heading"><span class="">Pemusnahan Arsip Tahap
                                    1</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                    </div>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-guest.php" class="d-block fh5co_small_post_heading"><span class="">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus
                                Mengikuti Uji Kompetensi Tahun 2023.</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                    </div>
                </div>
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita6-guest.php" class="d-block fh5co_small_post_heading"><span class=""> SDM dari Layanan Arsip
                                Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun
                                2023 </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
