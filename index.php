                    ...
                    <div class="row pb-3">
                        ...
                        <div class="col-7 paddding">
                            <div class="most_fh5co_treding_font">SDM dari Layanan Arsip
                                Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun 2023,.
                            </div>
                            <div class="most_fh5co_treding_font_123"> Agustus 25, 2018</div>
                        </div>
                    </div>
        ...
        <div class="container animate-box">
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-lg-4 ">
                    ...
                    <a href="berita1-guest.php" class="footer_img_post_6"><img src="images/pemusnahanarsip.jpeg"
                            alt="img" /></a>
                    <a href="berita1-guest.php" class="footer_img_post_6"><img
                            src="images/pemusnahan arsip foto ke 2.jpg" alt="img" /></a>
                    <a href="profil-guest.php" class="footer_img_post_6"><img
                            src="images/STRUKTUR ORGANISASI_page-0001.jpg" alt="img" /></a>
                    <a href="berita3-guest.php" class="footer_img_post_6"><img
                            src="images/kunjunganarsipkarangsambung.jpg" alt="img" /></a>
                    <a href="berita2-guest.php" class="footer_img_post_6"><img src="images/kunjunganugm.png"
                            alt="img" /></a>
