                ...
                <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                    ...
                    <div class="d-inline-block text-center dd_position_relative">
                        <select class="form-control fh5co_text_select_option" onchange="navigateToPage(this.value)">
                            ...
                            <option value="index-admin.php">Admin</option>
                            <option value="index-admin.php">LogOut</option>
                        </select>
                    </div>
        ...
        <div class="container paddding">
            <div class="row mx-0">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita2-admin.php" class="fh5co_magna py-2">Layanan Arsip Kawasan Yogyakarta Studi
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita3-admin.php" class="fh5co_magna py-2"> Kunjungan Tim Layanan Arsip Karang Sambung
                            Kebumen.
                        </a> <a href="berita3-admin.php" class="fh5co_mini_time py-3"> Layanan Sistem Informasi Kearsipan Yogyakarta
                            -
                            April 18,2016 </a>
                        <div class="fh5co_consectetur"> Tim Layanan Arsip Kawasan Yogyakarta Biro Komunikasi Publik,
                            Umum dan Kesekretariatan Badan
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita5-admin.php" class="fh5co_magna py-2">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus
                                Mengikuti Uji Kompetensi Tahun 2023. </a> <a href="berita5-admin.php"
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="berita6-admin.php" class="fh5co_magna py-2"> SDM dari Layanan Arsip
                                Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun
                                2023 </a> <a href="berita5-admin.php"
                            class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan Yogyakarta -
                            April 18,2016 </a>
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita3-admin.php" class="d-block fh5co_small_post_heading"><span class="">Kunjungan Tim Layanan Kearsipan
                                Karangsambung
                                Kebumen </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-admin.php" class="d-block fh5co_small_post_heading"><span class="">3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita6-admin.php" class="d-block fh5co_small_post_heading"><span class=""> SDM dari Layanan Arsip
                                Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun
                                2023 </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        </div>
