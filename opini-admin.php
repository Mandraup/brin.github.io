                    ...
                    <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                        ...
                        <div class="d-inline-block text-center dd_position_relative">
                            <select class="form-control fh5co_text_select_option" onchange="navigateToPage(this.value)">
                                ...
                                <option value="Login-admin.php">Login</option>
                            </select>
                        </div>
            ...
            <div class="row mx-0">
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <div class="row pb-4">
                        <div class="col-md-5">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/Opini.jpg" alt="" /></div>
                                <div></div>
                            </div>
                        </div>
                        <div class="col-md-7 animate-box">
                            <a href="berita1.php" class="fh5co_magna py-2"> Opini </a> <a href="opini1.php"
                                class="fh5co_mini_time py-3"> Sistem Informasi Layanan Kearsipan Yogyakarta (SI
                                ARYO)</a>
                            <div class="fh5co_consectetur"> Arsip sering dipandang sebelah mata oleh kebanyakan orang.
                                Di sisi lain, ada kalanya seseorang membutuhkan sumber informasi dan dokumentasi dari
                                arsip yang ada, baik itu digunakan sebagai sumber referensi kegiatan ilmiah, alat ukur
                                aktivitas suatu organisasi ataupun sebagai alat bukti yang sah.
                            </div>
                        </div>
                    </div>
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="berita2.php" class="fh5co_magna py-2">Opini </a> <a href="opini2.php" class="fh5co_mini_time py-3">
                                Karya Tulis Ilmiah Sebagai Upaya Peningkatan Kompetensi Calon Arsiparis </a>
                    ...
                    <div class="row pb-4">
                        <div class="col-md-5">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/Opini.jpg" alt="" />
                                </div>
                                <div></div>
                            </div>
                        </div>
