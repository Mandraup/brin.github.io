...
<body>
    ...
    <br></br>
    <div style="background-color:#F9F2C7FF">
    <input style="margin-left: 200px;" type="checkbox" name="" id="pengajuan" value="pengajuan" />
    <label style="font-size: 20px;margin-left: 0px;" for="pengajuan">Pengajuan</label>
    <input style="margin-left: 200px;" type="checkbox" name="" id="ditolak" value="ditolak" />
    <label style="font-size: 20px;margin-left: 0px;" for="ditolak">Ditolak</label>
    <input style="margin-left: 200px;" type="checkbox" name="" id="ditrima" value="ditrima" />
    <label style="font-size: 20px;margin-left: 0px;" for="ditrima">Ditrima</label>
    <input style="margin-left: 200px;" type="checkbox" name="konfirmasi pic" id="konfirmasi pic"
        value="konfirmasi pic" />
    <label style="font-size: 20px;margin-left: 0px;" for="konfirmasi pic">konfirmasi pic</label>

    <br></br>

    <input style="margin-left: 330px;" type="checkbox" name="penyerahan arsip" id="olahraga" value="olahraga" />
    <label style="font-size: 20px;margin-left: 0px;" for="penyerahan arsip">pencarian berkas</label>
    <input style="margin-left: 100px;" type="checkbox" name="penyerahan arsip" id="olahraga" value="olahraga" />
    <label style="font-size: 20px;margin-left: 0px;" for="penyerahan arsip">Penyerahan berkas</label>
    <input style="margin-left: 100px;" type="checkbox" name="penyerahan arsip" id="olahraga" value="olahraga" />
    <label style="font-size: 20px;margin-left: 0px;" for="penyerahan arsip">Pengembalian</label>
    </div>
    <br></br>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td><button onclick="showPopup()">emil </button></td>  
            <td>V</td>
            <td>V</td>
            <td>V</td>
            <td> </td>
        ...
        <tr>
            <td><button onclick="showPopup()">Cecelio</button> </td>
            <td>V</td>
            <td>V</td>
            <td>V</td>
            <td>V</td>
        ...
        <tr>
        <td><button onclick="showPopup()">husen</button> </td>
            <td>V</td>
            <td>V</td>
            <td>V</td>
            <td>V</td>
 ...
 <!-- Popup dan latar belakang gelap -->
 <div class="overlay" id="overlay"></div>
    <div style="background-color:#ebf8f9;"class="popup" id="popup">
        <h3>PopUp</h3>
        <p>Nama         : emil</p>
        <p>NIP          : 0128821743812</p>
        <p>Keperluan    : emil</p>
        <p>Instansi     : Brin </p>
        <p>Judul Arsip  : Instansi </p>
        <p>Email        : emil123</p>
        <p>No.WA        : 081312196234</p>
        <p>Alamat       : iabnndsnbhucbq </p>
        <p>Lampiran     : berkas x </p>
    ...
    <div style="background-color:#ebf8f9;"class="popup" id="popup2">
        <h3>PopUp</h3>
        <p>Nama         : cecelio</p>
        <p>NIP          : 0128821743812</p>
        <p>Keperluan    : emil</p>
    ...
    <div style="background-color:#ebf8f9;"class="popup" id="popup3">
        <h3>PopUp</h3>
        <p>Nama         : husen</p>
        <p>NIP          : 0128821743812</p>
        <p>Keperluan    : emil</p>
    ...
    <!-- Script JavaScript untuk menangani tampilan dan penutupan popup -->
    <script>
        function showPopup() {
