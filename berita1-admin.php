                ...
                <div class="row mx-0">
                    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                        <p style=" text-align: justify;">
                            ...
                            Pemusnahan arsip dalam tahap 1 ini berasal dari tiga eks entitas, yaitu Balai
                            Penelitian
                            Teknologi Bahan Alam (BPTBA-LIPI), eks Balai Teknologi Infrastruktur Pelabuhan dan Dinamika
                            Pantai
                            (BTIPDP–BPPT), serta eks Sekolah Tinggi Teknologi Nuklir (STTN-BATAN). 
                ...
                <div class="owl-carousel owl-theme" id="slider2">
                    ...
                    <div class="item px-2">
                        <div class="fh5co_hover_news_img">
                            ...
                            <div>
                                <a href="berita1-admin.php" class="d-block fh5co_small_post_heading"><span class="">The
                                        top 10 best
                                        computer speakers in the market</span></a>
                                <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                            </div>
