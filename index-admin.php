...
<body>
    ...
    <button class="edit-button" onclick="editAdmin()" style="top: 218px; right: 70px">Edit</button>
    ...
    <div class="container-fluid pt-3">
        <div class="container animate-box" data-animate-effect="fadeIn">
            <button class="edit-button" onclick="editAdmin()" style="top: 8px; right: 140px">Edit</button>
            <div>
            ...
            <div class="owl-carousel owl-theme" id="slider2">
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita2-admin.php" class="d-block fh5co_small_post_heading"><span class="">Layanan
                                    Arsip
                                    Kawasan Yogyakarta Studi Banding
                                    Kearsipan UGM</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oktober 16,2022</div>
                        </div>
                    </div>
                </div>
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita1-admin.php" class="d-block fh5co_small_post_heading"><span
                                    class="">Pemusnahan
                                    Arsip Tahap 1</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Desember 16,2023</div>
                        </div>
                    </div>
                </div>
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita3-admin.php" class="d-block fh5co_small_post_heading"><span
                                    class="">Kunjungan Team
                                    Layanan Kearsipan Karangsambung Kebumen </span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Januari 16,2023</div>
                        </div>
                    </div>
                </div>
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        <div class="fh5co_news_img"><img src="images/kunjungankedinasperpustakaanasrip.jpg" alt="" />
                        </div>
                        <div>
                            <a href="berita5-admin.php" class="d-block fh5co_small_post_heading"><span
                                    class="">Kunjungan
                                    Layanan Arsip Yogyakarta Ke Dinas Perpustakaan Dan Arsip Daerah</span></a>
                            <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2020</div>
                        </div>
                    </div>
                </div>
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-admin.php" class="d-block fh5co_small_post_heading"><span class="">3 SDM
                ...
                <div class="item px-2">
                    <div class="fh5co_hover_news_img">
                        ...
                        <div>
                            <a href="berita5-admin.php" class="d-block fh5co_small_post_heading"><span class="">SDM dari
                                    Layanan Arsip
    ...
    <div class="container-fluid fh5co_video_news_bg pb-4">
        <div class="container animate-box" data-animate-effect="fadeIn">
            <button class="edit-button" onclick="editAdmin()" style="top: 47px; right: 140px;">Edit</button>
            <div>
