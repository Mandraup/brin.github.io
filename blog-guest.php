...
<head>
    ...
    <title>Layanan Sistem Informasi Kearsipan
                                Yogyakarta</title>
            ...
            <nav class="navbar navbar-toggleable-md navbar-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="single-guest.php">Profil <span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item ">
        ...
        <div class="container paddding">
                ...
                <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7 animate-box">
                            <a href="berita1-guest.php" class="fh5co_magna py-2"> Pemusnahan Arsip Tahap 1 </a> <a
                                href="#" class="fh5co_mini_time py-3"> Layanan Sistem Informasi Kearsipan Yogyakarta -
                                April 18,2016 </a>
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="berita2-guest.php" class="fh5co_magna py-2">Layanan Arsip Kawasan Yogyakarta Studi
                    ...
                    <div class="row pb-4">
                        ...
                        <div class="col-md-7">
                            <a href="berita3-guest.php" class="fh5co_magna py-2"> Kunjungan Tim Layanan Arsip Karang
                                Sambung
                                Kebumen.
                    ...
                    <div class="row pb-4">
                        <div class="col-md-5">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/sertifikasi_jabatan.jpeg"
                        ...
                        <div class="col-md-7">
                            <a href="berita5-guest.php" class="fh5co_magna py-2">3 SDM
                                Layanan Arsip Kawasan Yogyakarta Telah Lulus Mengikuti Uji Kompetensi Tahun
                                2023,</a> <a href="#" class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan
                                Yogyakarta -
                                Maret 11,2023 </a>
                            <div class="fh5co_consectetur">Pada bulan Agustus lalu, 3 orang SDM dari Tim Layanan Arsip
                                Kawasan Yogyakarta mengikuti Uji Kompetensi atau yang sering disebut sebagai sertifikasi
                                jabatan fungsional yang diselenggarakan oleh Arsip Nasional Republik Indonesia
                            </div>
                        </div>
                    </div>
                    <div class="row pb-4">
                        <div class="col-md-5">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/Picture1.jpg"
                                        style="width: 100px;height: 200px;alt="" />
                                </div>
                                <div></div>
                            </div>
                        ...
                        <div class=" col-md-7">
                                    <a href="berita6-guest.php" class="fh5co_magna py-2">SDM dari Layanan Arsip
                                        Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun
                                        2023</a>
                                    <a href="#" class="fh5co_mini_time py-3">Layanan Sistem Informasi Kearsipan
                                        Yogyakarta -
                                        Maret 11,2023 </a>
                                    <div class="fh5co_consectetur">Ken Fitria Indrawardani dan Dhatu Kamajati yang
                                        merupakan SDM
                                        dari Tim Fungsi Layanan Arsip Kawasan Yogyakarta bersama dengan Dwi Ridho
                                        Aulianto ,
                                        arsiparis Unit Kearsipan I Thamrin Biro Komunikasi Publik, Umum dan
                                        Kesekretariatan,
                                        Badan Riset dan Inovasi Nasional (BKPUK-BRIN) berhasil meraih predikat Juara 2
                                        dalam
                                        Lomba Karya Tulis Kearsipan (LKTK) Tahun 2023
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                            <div>
                                <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Tanda</div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div>
                                <div class="fh5co_heading fh5co_heading_border_bottom pt-3 py-2 mb-4">Sedang Populer
                                </div>
                            </div>
                            <div class="row pb-3">
                                <div class="col-5 align-self-center">
                                    <img src="images/kunjunganugm.png" class="fh5co_most_trading" />
                                </div>
                            ...
                            <div class="row pb-3">
                                <div class="col-5 align-self-center">
                                    <img src="images/pemusnahan arsip foto ke 2.jpg" class="fh5co_most_trading" />
                                </div>
                                <div class="col-7 paddding">
                            ...
                            <div class="row pb-3">
                                <div class="col-5 align-self-center">
                                    <img src="images/kunjunganarsipkarangsambung.jpg" class="fh5co_most_trading" />
                                </div>
                                <div class="col-7 paddding">
                                    <div class="most_fh5co_treding_font"> Kunjungan Tim Layanan Arsip Karang Sambung
                                        Kebumen.
                                    </div>
                                    <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                                </div>
                            ...
                            <div class="row pb-3">
                                <div class="col-5 align-self-center"><img src="images/pemusnahanarsip.jpeg"
                            ...
                            <div class="row pb-3">
                                <div class="col-5 align-self-center"><img src="images/sertifikasi_jabatan.jpeg"
                                        class="fh5co_most_trading" /></div>
                                <div class="col-7 paddding">
                                    <div class="most_fh5co_treding_font">3 SDM Layanan Arsip Kawasan Yogyakarta Telah
                                        Lulus
                            ...
                            <div class="row pb-3">
                                <div class="col-5 align-self-center"><img src="images/Picture1.jpg"
                                        class="fh5co_most_trading" /></div>
                                <div class="col-7 paddding">
            ...
            <div class="container-fluid pb-4 pt-5">
                <div class="container animate-box">
                    <div>
                        <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Baru Baru Ini</div>
                    </div>
                    <div class="owl-carousel owl-theme" id="slider2">
                        <div class="item px-2">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/kunjunganugm.png" alt="" /></div>
                                <div>
                                    <a href="berita2-guest" class="d-block fh5co_small_post_heading"><span
                                            class="">Layanan
                                            Arsip Kawasan
                                            Yogyakarta Studi Banding Kearsipan UGM </span></a>
                        ...
                        <div class="item px-2">
                            <div class="fh5co_hover_news_img">
                                ...
                                <div>
                                    <a href="berita4-guest" class="d-block fh5co_small_post_heading"><span
                                            class="">Layanan
                                            Arsip Kawasan
                                            Yogyakarta Studi Banding Kearsipan UGM </span></a>
                                    <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        ...
                        <div class="item px-2">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/pemusnahanarsip.jpeg" alt="" /></div>
                                <div>
                                    <a href="berita1-guest" class="d-block fh5co_small_post_heading"><span
                                            class="">Pemusnahan
                                            Arsip Tahap
                                            1</span></a>
                                    <div class="c_g"><i class="fa fa-clock-o"></i> Oct 16,2017</div>
                        ...
                        <div class="item px-2">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/sertifikasi_jabatan.jpeg" alt="" /></div>
                                <div>
                                    <a href="berita1-guest.php" class="d-block fh5co_small_post_heading"><span
                                            class="">3 SDM
                                            Layanan Arsip Kawasan Yogyakarta Telah Lulus Mengikuti Uji Kompetensi Tahun
                                            2023</span></a>
                                    <div class="c_g"><i class="fa fa-clock-o"></i> Agustus 25, 2023</div>
                                </div>
                            </div>
                        </div>
                        <div class="item px-2">
                            <div class="fh5co_hover_news_img">
                                <div class="fh5co_news_img"><img src="images/Picture1.jpg" alt="" /></div>
                                <div>
                                    <a href="berita1-guest.php" class="d-block fh5co_small_post_heading"><span
                                            class="">SDM dari
                                            Layanan Arsip
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 col-lg-2">
                            ...
                            <ul class="footer_menu">
                                ...
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Kunjungan</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Penelitian</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Layanan Arsip</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Buat Akun</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Sumber Daya</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Teknologi</a>
                                </li>
                                <li><a href="#" class=""><i class="fa fa-angle-right"></i>&nbsp;&nbsp; Lingkungan</a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-4 ">
                            ...
                            <a href="berita1.php" class="footer_img_post_6"><img src="images/pemusnahanarsip.jpeg"
                                    alt="img" /></a>
                            <a href="berita1.php" class="footer_img_post_6"><img
                            ...
                            <a href="berita2.php" class="footer_img_post_6"><img src="images/kunjunganugm.png"
                                    alt="img" /></a>
                            <a href="profil.php" class="footer_img_post_6"><img src="images/LOGO BATAN.png"
                                    alt="img" /></a>
                            ...
                            <a href="profil.php" class="footer_img_post_6"><img src="images/profil.jpeg"
                                    alt="img" /></a>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row  ">
                        <div class="col-12 col-md-6 py-4 Reserved"> © Copyright 2023, All rights reserved. Design by <a
                                href="https://freehtml5.co" title="Free php5 Bootstrap templates">Layanan Sistem
                                Informasi
