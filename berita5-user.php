...
<php lang="en" class="no-js">
    ...
    <body class="single">
        ...
        <div id="fh5co-title-box"
            style="background-image: url(images/sertifikasi_jabatan.jpeg); background-position: 50% 90.5px;"
            data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="page-title">
                <span>Agustus 25, 2023</span>
                <h2>3 SDM Layanan Arsip Kawasan Yogyakarta Telah Lulus Mengikuti Uji Kompetensi Tahun 2023</h2>
            </div>
        </div>
            ...
            <div class="container paddding">
                <div class="row mx-0">
                    ...
                    <p style=" text-align: justify;">
                            Pada bulan Agustus lalu, 3 orang SDM dari Tim Layanan Arsip Kawasan Yogyakarta mengikuti Uji
                            Kompetensi atau yang sering disebut sebagai sertifikasi jabatan fungsional yang
                            diselenggarakan oleh Arsip Nasional Republik Indonesia. Sertifikasi Jabatan Fungsional
                            Arsiparis adalah proses pemberian sertifikat kompetensi kearsipan kepada Arsiparis PNS yang
                            dilakukan secara sistematis dan obyektif melalui uji kompetensi yang mengacu pada Standar
                            Kompetensi Jabatan Fungsional Arsiparis. Pelaksanaan uji kompetensi tahun ini dilakukan
                            secara offline di kantor pusat Badan Riset dan Inovasi Nasional Thamrin Jakarta selama 3
                            hari , mulai tanggal 23 sampai dengan 25 Agustus 2023. Pelaksanaan uji kompetensi dilakukan
                            serentak melalui Unit Kearsipan I Badan Riset dan Inovasi Nasional bekerjasama dengan
                            Direktorat SDM Kearsipan dan Sertifikasi Arsip Nasional Republik Indonesia. Berdasarkan
                            Peraturan Kepala ANRI Nomor 6 Tahun 2016 tentang Pedoman Sertifikasi Jabatan Fungsional
                            Arsiparis, pelaksanaan ujian dalam kegiatan sertifikasi terdiri dari Ujian Tertulis dan
                            Ujian Wawancara bagi semua jenjang peserta, Ujian Praktek bagi semua jejang peserta kecuali
                            calon Arsiparis Ahli Madya, Ujian Presentasi khusus bagi calon Arsiparis Ahli Madya, dan
                            penulisan Makalah bagi calon Arsiparis Ahli Muda dan Ahli Madya. Seluruh kegiatan ujian
                            dalam kegiatan sertifikasi ini dilakukan dengan memanfaatkan teknologi informasi dan
                            komunikasi (TIK). Bobot Nilai Kelulusan Sertifikasi Jabatan Fungsional Arsiparis Ahli Madya
                            terdiri atas penilaian Portofolio: Bobot 15%, Ujian Tertulis: Bobot 20%, Makalah: Bobot 20%,
                            Presentasi: Bobot 25% dan Wawancara: Bobot 20%. Bobot Nilai Kelulusan Sertifikasi Jabatan
                            Fungsional Arsiparis Ahli Muda Penilaian Sertifikasi Jabatan Fungsional Arsiparis Ahli
                            Muda/Muda terdiri atas penilaian Portofolio: Bobot 15%, Ujian Tertulis: Bobot 20%, Ujian
                            Praktik: Bobot 20%, Makalah: Bobot 25% dan Wawancara: Bobot 20%. Penilaian Sertifikasi
                            Jabatan Fungsional Arsiparis Mahir/Pelaksana Lanjutan, Portofolio: Bobot 20%, Ujian
                            Tertulis: Bobot 30%, Ujian Praktik: Bobot 30%, Wawancara: Bobot 20%. Selamat kepada Tim
                            Layanan Arsip Kawasan Yogyakarta yang telah berhasil lulus uji kompetensi tahun 2023,
                            Sulistyowati Dwi Untari naik ke jenjang Arsiparis Ahli Madya, Dwi Hastuti Listyowati naik ke
                            jenjang Arsiparis Ahli Muda dan Miftahu Rokhmat naik ke jenjang Arsiparis Mahir. Semoga
                            dengan bertambahnya jenjang keahlian pada Tim Layanan Arsip Kawasan Yogyakarta, akan semakin
                            meningkatkan kualitas kerja tim ke depan.
                        </p>
                    </div>
