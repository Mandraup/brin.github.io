...
<html lang="en" class="no-js">
    ...
    <body class="single">
        ...
        <div id="fh5co-title-box" style="background-image: url(images/Picture1.jpg); background-position: 50% 90.5px;"
            data-stellar-background-ratio="0.5">
            <div class="overlay"></div>
            <div class="page-title">
                <span>Agustus 25, 2023</span>
                <h2>SDM dari Layanan Arsip
                    Kawasan Yogyakarta berhasil meraih predikat Juara 2 dalam Lomba (LKTK) Tahun 2023</h2>
            </div>
        </div>
                ...
                <div class="row mx-0">
                    <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                        <p style=" text-align: justify;">
                            Ken Fitria Indrawardani dan Dhatu Kamajati yang merupakan SDM dari Tim Fungsi Layanan Arsip
                            Kawasan Yogyakarta bersama dengan Dwi Ridho Aulianto , arsiparis Unit Kearsipan I Thamrin
                            Biro Komunikasi Publik, Umum dan Kesekretariatan, Badan Riset dan Inovasi Nasional
                            (BKPUK-BRIN) berhasil meraih predikat Juara 2 dalam Lomba Karya Tulis Kearsipan (LKTK) Tahun
                            2023, yang diadakan setiap tahun oleh Unit Arsip Universitas Gadjah Mada. Pada tahun 2023,
                            LKTK dilaksanakan mulai rentang waktu tanggal 21 Agustus – 21 Oktober 2023 dengan dua
                            kategori yaitu Kategori Umum/ Pelajar/ Mahasiswa dan Kategori Arsiparis/ Pengelola Arsip,
                            dengan tiga tema besar yaitu, 1. Pengembangan SDM Kearsipan, 2. Peranan Arsip dalam
                            Pengembangan Pendidikan dan Ilmu Pengetahuan dan 3. Kearsipan dan Isu Isu Terkini.

                            Judul Karya Tulis yang diikutsertakan dalam lomba tersebut yaitu “Persepsi Periset Pusat
                            Riset Teknologi dan Proses Pangan BRIN terhadap Pengelolaan Arsip Hasil Penelitian”.
                            Penulisan karya tulis ini melibatkan periset dari Pusat Riset Teknologi dan Proses Pangan
                            (PRTPP) dengan metode pengumpulan data sebagai dasar persepsi para periset yang berada di
                            bawah
                        </p>
                    </div>
